...
function App() {
  ...
  return (
    <div 
    className='w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repreat'
    style={ { backgroundImage: `url('https://img.freepik.com/premium-photo/3d-leadership-with-money-loan-excellent-investing-business-graph-background-3d-investment-creative-solution-with-money-coin-graph-concept-3d-vector-finance-render-blue-background_839035-1703306.jpg')`}}
    >
